...
interface EmailContactData extends Contact {
    country?: string;
}
...
export class EmailService {
    ...
    async sendContactNotification(contactData: EmailContactData): Promise<void> {
        ...
        const ipDisplay = ip || 'Desconocido';
        ...
        const htmlContent = `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
                ...
                <div style="margin: 20px 0; padding: 15px; background-color: #f9f9f9; border-radius: 5px;">
                    ...
                    <p style="margin: 5px 0;"><strong>IP del Cliente:</strong> ${ipDisplay}</p>
